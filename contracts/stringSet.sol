...
library stringSet {
    ...
    function insert(_stringSet storage self, string memory  other) public {
    ...
    function remove(_stringSet storage self, string memory  other) public {
        if (contains(self, other)) {
    ...
    function contains(_stringSet storage self, string memory other) public view returns (bool) {
